...
<div class="span9">
    <ul class="breadcrumb">
        ...
        <li class="active">{{ $categoryDetails['categoryDetails']['category_name'] }}</li>
    </ul>
    <h3> {{ $categoryDetails['categoryDetails']['category_name'] }} <small class="pull-right"> 40 products are available </small></h3>
    <hr class="soft"/>
    <p>
