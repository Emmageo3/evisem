...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
			...
			<div class="item">
				<div class="container">
					<a href="register.html"><img style="width:100%" src="{{ asset('images/front_images/carousel/1.png') }}" alt=""/></a>
					<div class="carousel-caption">
			...
			<div class="item">
				<div class="container">
					<a href="register.html"><img src="{{ asset('images/front_images/carousel/1.png') }}" alt=""/></a>
					<div class="carousel-caption">
